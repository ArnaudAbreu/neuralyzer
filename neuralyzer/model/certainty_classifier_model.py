...
class CCLF(Model):
    ...
    def __init__(self, clf, height=28, width=28, colors=1, n_classes=10, learning_rate=0.001, optimizer='Adam', model_path=None, sampling=100):
    ...
    def predict(self, x):
        ...
        feed_dict = {self.X: x, K.learning_phase(): 1}
        y_pred = [self.sess.run([self.Y_pred], feed_dict=feed_dict) for _ in range(self.sampling)]
        return y_pred
